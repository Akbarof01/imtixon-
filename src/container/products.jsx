...
import { addTodo } from "../store/todoSliceStore";
          ...
          <div key={item.id} className="card w-[352px] h-[400px] bg-base-100 shadow-xl">
            ...
            <div className="card-body items-center text-center">
              ...
              <button
                ...
                className="btn bg-primary text-white w-[220px]"
              >
                Buy
              </button>
            </div>
            <dialog id={`my_modal_${item.id}`} className="modal ">
              <div className="modal-box flex flex-col w-[300px] h-[500px] text-center">
                ...
                <h3 className="font-bold text-lg mb-[10px]">harid qilish</h3>
                <div className="flex justify-center items-center gap-[20px]">
                  <button onClick={(e)=> {
                    
                  }} className="btn w-[100px] btn-secondary">-</button>
                  <span>1</span>
                  <button className="btn w-[100px] btn-secondary">+</button>
                </div>
                ...
                <div className="flex justify-center items-center mt-[30px]">
                  <button onClick={()=>addCard(item)} className="btn w-[100px] btn-primary">buy</button>
                </div>
              </div>
            </dialog>
          </div>
